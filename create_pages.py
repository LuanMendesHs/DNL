        ...
        <div class="flex items-center space-x-3">
          <a href="/" class="flex items-center space-x-3">
            ...
            <div class="hidden sm:block">
              <div class="text-white font-bold text-lg">Breathe Safe</div>
              <div class="text-gray-400 text-xs">Demolition & Asbestos Removal</div>
            </div>
          </a>
        </div>
  ...
  <footer class="bg-brand-gray border-t border-brand-red/20 py-12">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <!-- Company Info -->
        <div>
          <img src="assets/images/logo_header_optimized.png" alt="Breathe Safe" class="h-12 mb-4">
          <p class="text-gray-400 mb-4">Licensed asbestos removal and demolition specialists serving Gold Coast to Sunshine Coast.</p>
        ...
        <div>
          ...
          <div class="space-y-3">
            ...
            <div class="flex items-center space-x-3">
              ...
              <a href="mailto:contactbreathsafe@gmail.com" class="hover:text-brand-red transition-colors">contactbreathsafe@gmail.com</a>
            </div>
            <div class="flex items-center space-x-3">
      ...
      <div class="border-t border-gray-600 mt-8 pt-8 text-center text-gray-400">
        <p>&copy; 2024 Breathe Safe Demolition & Asbestos Removal. All rights reserved.</p>
...
pages = {
    ...
    'about.html': {
        ...
        'meta': '<meta name="description" content="Learn about Breathe Safe - licensed asbestos removal specialists with 500+ completed projects. EPA compliant, fully insured, serving Gold Coast to Sunshine Coast." />',
        'canonical': '<link rel="canonical" href="https://breathesafe.com.au/about" />',
        'og': '<meta property="og:title" content="About Breathe Safe | Licensed Specialists" /><meta property="og:description" content="Licensed asbestos removal specialists with 500+ completed projects and zero accidents." />',
    ...
    'reviews.html': {
        ...
        'meta': '<meta name="description" content="Read genuine client reviews and testimonials for Breathe Safe asbestos removal and demolition services. 4.9/5 stars with 85+ verified reviews." />',
        'canonical': '<link rel="canonical" href="https://breathesafe.com.au/reviews" />',
        'og': '<meta property="og:title" content="Client Reviews | Breathe Safe" /><meta property="og:description" content="4.9/5 stars with 85+ verified reviews from satisfied clients across Gold Coast to Sunshine Coast." />',
  ...
  <section class="relative py-20 hero-pattern">
    <div class="container mx-auto px-4">
      <div class="text-center max-w-4xl mx-auto">
        ...
        <p class="text-xl text-gray-300 mb-8 leading-relaxed">
          Licensed asbestos removal specialists with over 3 years of experience and 500+ completed projects. 
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p class="text-gray-300 mb-6">
            With over 3 years of dedicated service and 500+ successfully completed projects, we've built our reputation on safety, professionalism, and customer satisfaction. Our team of licensed specialists follows all Australian safety protocols and regulations.
          </p>
          ...
          <div class="grid grid-cols-3 gap-6 text-center">
            <div>
              <div class="text-3xl font-bold text-brand-red">500+</div>
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="text-center">
          ...
          <h3 class="text-xl font-bold text-white mb-2">$20M Insured</h3>
...
''',
  ...
  <section class="py-20 bg-brand-gray/30">
    <div class="container mx-auto px-4">
      ...
      <div class="grid md:grid-cols-4 gap-8">
        <div class="text-center">
          <div class="text-4xl font-bold text-brand-red mb-2">4.9/5</div>
        ...
        <div class="bg-brand-gray/30 rounded-2xl p-8 border border-white/10">
          ...
          <div class="mt-6 pt-6 border-t border-gray-600">
            <p class="text-gray-400 text-sm">
              Or contact us directly at <a href="mailto:contactbreathsafe@gmail.com" class="text-brand-red hover:text-white transition-colors">contactbreathsafe@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
  ...
  <section class="py-20 bg-brand-red">
    <div class="container mx-auto px-4 text-center">
      ...
      <p class="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
        Experience the same professional service that has earned us 4.9/5 stars and 98% customer satisfaction.
      </p>
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="quote.html" class="bg-white text-brand-red px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-colors">
          <i class="fas fa-calculator mr-2"></i>Get Free Quote
          ...
          <div class="bg-brand-gray/30 rounded-2xl p-8 border border-white/10">
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center space-x-3">
                <i class="fas fa-envelope text-brand-red"></i>
                <div>
                  <div class="text-white font-bold">contactbreathsafe@gmail.com</div>
